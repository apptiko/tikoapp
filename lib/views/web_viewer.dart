...
class _WebViewerState extends State<WebViewer> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: (widget.appConfig.template != Template.blank && widget.appConfig.template != Template.bottom_tab) 
        ? Navbar(
        ...
        : null,
        body: SafeArea(
         top: (widget.appConfig.template == Template.blank || widget.appConfig.template == Template.bottom_tab),
          child: !isOffline 
              ? IndexedStack(
                  index: activePage,
                  children: [
        ...
        bottomNavigationBar: (widget.appConfig.template == Template.tabs || widget.appConfig.template == Template.bottom_tab)
        ? AppTabs(
            actions: widget.appConfig.mainNavigation,
  ...
  void createCollection() {
    if ((widget.appConfig.template == Template.tabs || widget.appConfig.template == Template.bottom_tab) 
    && widget.appConfig.mainNavigation.length > 1) {
